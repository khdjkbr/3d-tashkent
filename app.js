...
map.on('load', () => {
  ...
  map.addLayer({ id: 'osm-bridge-slabs', type: 'fill-extrusion', source: 'osm-bridgeSlabs', layout: { visibility: 'none' }, paint: { 'fill-extrusion-color': '#75695e', 'fill-extrusion-base': ['get', 'base'], 'fill-extrusion-height': ['get', 'height'], 'fill-extrusion-opacity': 0.68 } });
